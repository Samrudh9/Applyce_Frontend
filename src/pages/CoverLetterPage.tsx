                        ...
                        <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} onClick={(e) => e.stopPropagation()} className="w-full max-w-lg max-h-[90vh] overflow-y-auto">
                            <Card hover={false}>
                                ...
                                <div className="space-y-4">
                                    <div><label className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-ink-sec">Job Title *</label><input type="text" className={inputClass} value={jobTitle} onChange={(e) => setJobTitle(e.target.value)} placeholder="Software Engineer" /></div>
                                    <div><label className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-ink-sec">Company *</label><input type="text" className={inputClass} value={company} onChange={(e) => setCompany(e.target.value)} placeholder="Google" /></div>
                                    <div><label className="mb-1.5 block text-xs font-medium uppercase tracking-wider text-ink-sec">Job URL (optional)</label><input type="url" className={inputClass} value={jobUrl} onChange={(e) => setJobUrl(e.target.value)} placeholder="https://..." /></div>
